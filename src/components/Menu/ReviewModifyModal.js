            ...
            <Column className="col-start-3 col-end-8 h-auto">
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-4"
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full" onClick={(e) => e.stopPropagation()}>
                        ...
                        <Row className="mt-16 text-2xl">리뷰 작성</Row>
                        ...
                        <input
                            ...
                            placeholder="내용을 작성하세요" value={editedReviewComment} onChange={editedCommentChange}/>
                        <Row className="text-lg">별점</Row>
                        <input
                            className="border-solid border mt-4 border-gray-300 rounded-lg h-12 p-4 w-1/2 bg-white text-gray-900 font-normal text-base"
                            placeholder="별점을 입력하세요" value={editedReviewScore} onChange={editedScoreChange}/>

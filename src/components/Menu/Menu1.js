...
export default function Menu1() {
    ...
    return (
        <div className="col-start-1 col-end-4 w-full h-auto pt-16 pl-16">
            <Box className=''>
                <Link to='/menu/memberInfo'><Row className='text-2xl font-medium'>내 정보 관리</Row ></Link>
                ...
                <Row className='mt-8 border-b border-b-gray-300'></Row>
                <Link to='/menu/visited'><Row className='mt-6 text-2xl font-medium'>내가 쓴 리뷰</Row></Link>
            </Box >
        </div>
    )
}

...
export default function Reservation1() {
    ...
    return (
        <Column className="col-start-3 col-end-8 h-auto">
            ...
            <input className="border-solid border mt-4 border-gray-300 rounded-lg h-12 p-4 w-1/2 bg-white text-gray-900 font-normal text-base" placeholder="이름을 입력하세요" onChange={nameChange}/>
            <Row className="text-lg">휴대폰 번호</Row>
            <input className="border-solid border mt-4 border-gray-300 rounded-lg h-12 p-4 w-1/2 bg-white text-gray-900 font-normal text-base" placeholder="번호를 입력하세요" onChange={telnoChange}/>
            <Row className="text-lg" >이메일</Row>
            <input className="border-solid border mt-4 border-gray-300 rounded-lg h-12 p-4 w-1/2 bg-white text-gray-900 font-normal text-base" placeholder="이메일을 입력하세요" onChange={useridChange}/>
            <Row className="text-lg" >요청사항</Row>
            <textarea className="border-solid border mt-4 border-gray-300 rounded-lg h-300 p-4 w-1/2 bg-white text-gray-900 font-normal text-base" placeholder="요청사항을 입력하세요" onChange={descriptionChange}/>
        </Column>
    )
}

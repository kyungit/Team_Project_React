            ...
            <Box>
                <Column className="text-gray-500">
                    ...
                    {reservation && (
                        ...
                        <div>
                            <Row>투숙일 : {searchdata.startDate}
                                                    <span className="font-medium">({getDayName(searchdata.startDate)}</span>)
                                                    ~ {searchdata.endDate}
                            ...
                            <Row>결제 금액
                                //////////////////// {(reservation.r_price - reservation.r_price * reservation.d_discount / 100).toLocaleString()}원</Row>

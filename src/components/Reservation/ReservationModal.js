            ...
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="px-10 py-6">
                    ...
                    <div className="grid grid-cols-1 gap-y-3 mb-5">
                        <div className="text-lg">숙소명 : <span className="font-medium">{reservationdata.d_name}</span>
                        </div>
                        <div className="text-lg">객실명 : <span className="font-medium">{reservationdata.r_name}</span>
                        </div>
                    </div>
                    ...
                    <div>번호 : <span className="font-medium">{reservationdata.m_telno}</span></div>
                    ...
                    <div className="mb-5">환불정책 : <span className="font-medium">고민~</span></div>
                    <div className="mt-5">
                        <Payment data={reservationdata.reservation_price} />
                    </div>
                </div>
            </div>
        </div>
